          ...
          <div className="row">
            ...
            <div className="col-md-8">
              ...
              <p className="lh-lg">
                ...
                don&apos;t just wash cars; we elevate the entire experience.
                Drive away not just with a clean car but with a renewed
                appreciation for the artistry of car care. It&apos;s time to
                unlock the true potential of your vehicle — a potential that
                gleams with brilliance at every turn. Welcome to a world where
                your car&apos;s radiance becomes a driving sensation.
              </p>
