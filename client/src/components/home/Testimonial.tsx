          ...
          >
            <div className="carousel-inner">
              <div className="carousel-item active">
                <p>
                  My car has never been cleaner and I&apos;ve used a few
                  different companies over the years. I am very pleased with the
                  detail and will continue using Extra Detailers from now on
                </p>
