...
function Footer() {
  return (
    <footer className={`${styles.footer} text-white`}>
      ...
      {/* Bottom Section */}
      <div className={`${styles.footerBottom} bg-dark py-5`}>
          ...
          <div className="row">
            <div className="col-md-3">
              ...
              <div className="d-flex gap-3 mt-3">
                <a href="#" className="border rounded-circle p-2"><FaFacebookF /></a>
                <a href="#" className="border rounded-circle p-2"><FaTwitter /></a>
                <a href="#" className="border rounded-circle p-2"><FaYoutube /></a>
                <a href="#" className="border rounded-circle p-2"><FaLinkedinIn /></a>
              </div>
            </div>
            <div className="col-md-3">
